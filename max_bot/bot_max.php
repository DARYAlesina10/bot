...
// ID менеджеров в MAX – используются для отдельных уведомлений
$managers = [
    // пример: 346607100,
];

// ID чата поддержки MAX (аналог support-чата с тредами)
...
// Запрос к API MAX sendMessage (с логированием)
// Запрос к API MAX sendMessage (с логированием)
